...
<button type="button" class="text-center btn text-light p-3" data-bs-toggle="modal" data-bs-target="#exampleModal">
  ...
  <div className="card-producto d-flex justify-content-center p-0 m-3 col-2">
    <div className="card text-center">
      ...
      <div className="card-body p-2">
        ...
        <button type="button" className="boton-productos-destacados btn bg-warning text-light mb-1" data-bs-toggle="modal" data-bs-target="#exampleModal">Editar</button>
        <button type="button" className="btn bg-danger text-light mt-1" data-bs-toggle="modal" data-bs-target="#exampleModal">
          Eliminar
        </button>
        </div>
      </div>

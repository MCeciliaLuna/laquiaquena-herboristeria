...
const CardProductoPublico = ({productos = []}) => {
  ...
  return (
    ...
    <div className="card-producto d-flex justify-content-center p-0 m-3 col-2 align-items-around" key={producto._id}>
            <div className="card text-center card-productopublico">
              ...
              <div className="card-body p-2">
                <h4 className="cardpublico-titulo card-title my-2 mb-0 d-flex justify-content-center align-items-center">{producto.nombre}</h4>
                <p className="cardpublico-descripcion card-text m-0 p-0 d-flex justify-content-center align-items-center">{producto.descripcion}</p>
                <div className="text-center">
                  ...
                  <button
                    type="button"
                    className="btn text-light mt-3 align-items-end"
                  > 
                    Comprar
                  </button> </a>
                </div>

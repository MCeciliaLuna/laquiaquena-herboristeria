...
const TablePedidosAdmin = () => {
  ...
  <div className="card-body">
    <p className="text-muted">{pedido.datetime}</p>
    <h4 className="card-title title-pedido">{pedido.nombre}</h4>
    <p className="card-text">{pedido.pedido}</p>
    <h5 className="mb-2">TOTAL: ${pedido.precio}</h5>
    ...
    <a href={`https://api.whatsapp.com/send?phone=${pedido.telefono}`} target="new" className="card-link m-0 p-0">

...
const Contacto = () => {
  return (
    ...
    <div className="div-contacto d-inline-flex w-100">
    <div className="mapa d-flex w-50 justify-content-center py-3">
    ...
    <img className="icono w-25 m-1 p-2" src="https://es.logodownload.org/wp-content/uploads/2018/10/whatsapp-logo-11.png" alt="" />
      <img className="icono w-25 m-1 p-2" src="https://logodownload.org/wp-content/uploads/2014/09/facebook-logo-3-1.png" alt="" />
      <img className="icono w-25 m-1 p-2" src="https://assets.stickpng.com/images/580b57fcd9996e24bc43c521.png" alt="" />
     </div>

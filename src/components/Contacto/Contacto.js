...
const Contacto = () => {
  return (
    ...
    <div className="iconos-redes p-3 w-50">
      <label className="d-block fs-5 text-light">Email de Contacto</label>
      <input className="input-contacto rounded-3 p-1 border-0 d-block w-100 fs-5" type="text" name="email" id="" />
      <label className="d-block fs-5 text-light">Nombre / Asunto</label>
      <input className="input-contacto rounded-3 p-1 border-0 d-block w-100 fs-5" type="text" name="nombre-asunto" id="" />
      <label className="d-block text-light fs-5" >Mensaje</label>
      <textarea className="input-contacto rounded-3 p-1 border-0 d-block w-100 fs-5" name="mensaje" rows="5"></textarea>
